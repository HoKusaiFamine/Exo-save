    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('date_debut', DateType::class, [
                ...
                'format' => 'dd-MM-yyyy' ,  
                'data' => (new \DateTime()), // Ajouter cette option pour utiliser la date de début plus une semaine comme valeur par défaut            
                //modification du des dropdown menu en attente
            ])
            ...
            ->add('date_fin',  DateType::class, [
                ...
                'format' => 'dd-MM-yyyy',
                'data' => (new \DateTime())->modify('+1 week'), // Ajouter cette option pour utiliser la date de début plus une semaine comme valeur par défaut                            
                //modification du des dropdown menu en attente
            ]);
